...
class StoneWranglerUtils {
    ...
    static void drawCircle(Mat mat, double x, double y, int radius) {
        Imgproc.circle(mat, new Point(x, y), radius, new Scalar(255, 0, 0));
    }
    ...
    static MatOfPoint2f createMatOfPoint2f(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4) {
        ...
        result.fromArray(new Point(x1, y1), new Point(x2, y2),
