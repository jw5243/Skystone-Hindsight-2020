...
public class FieldNavigation {
    ...
    public boolean hasUpdatedPosition = true;
    public Pose2d updatedPosition;
    ...
    public void loop() {
        ...
        if(targetVisible) {
            ...
            updatedPosition = new Pose2d(translation.get(0) / mmPerInch, translation.get(1) / mmPerInch, new Rotation2d(rotation.thirdAngle, false));
        } else {
