...
public class ResidualVibrationReductionMotionProfilerGenerator implements IMotionProfile {
    ...
    private static final ResidualVibrationReductionMotionProfilerGenerator FEEDER_STONE_TO_OUTTAKE_PROFILE_EXTEND;
    private static final ResidualVibrationReductionMotionProfilerGenerator FEEDER_UNDER_SKYBRIDGE_PROFILE_EXTEND;
    private static final ResidualVibrationReductionMotionProfilerGenerator FEEDER_STONE_TO_OUTTAKE_PROFILE_RETRACT;
    private static final ResidualVibrationReductionMotionProfilerGenerator FEEDER_UNDER_SKYBRIDGE_PROFILE_RETRACT;
    ...
    static {
        STANDARD_MOTION_PROFILES = new ResidualVibrationReductionMotionProfilerGenerator[40];
        FOUNDATION_MOTION_PROFILE = new ResidualVibrationReductionMotionProfilerGenerator(
                0d, 24d, 30d, 50d
        );

        FEEDER_STONE_TO_OUTTAKE_PROFILE_EXTEND = new ResidualVibrationReductionMotionProfilerGenerator(
                0d, Feeder.getExtensionSetpointStoneToOuttake(), 5d * 6d, 50d * 6d
        );

        FEEDER_UNDER_SKYBRIDGE_PROFILE_EXTEND = new ResidualVibrationReductionMotionProfilerGenerator(
                0d, Feeder.getExtensionSetpointUnderSkybridge(), 5d * 6d, 50d * 6d
        );

        FEEDER_STONE_TO_OUTTAKE_PROFILE_RETRACT = new ResidualVibrationReductionMotionProfilerGenerator(
                Feeder.getExtensionSetpointStoneToOuttake(), 0d, 5d * 6d, 50d * 6d
        );

        FEEDER_UNDER_SKYBRIDGE_PROFILE_RETRACT = new ResidualVibrationReductionMotionProfilerGenerator(
                Feeder.getExtensionSetpointUnderSkybridge(), 0d, 5d * 6d, 50d * 6d
        );
    }
    ...
    public static void init() {
        for(int i = 0; i < STANDARD_MOTION_PROFILES.length / 2; i++) {
            ...
            STANDARD_MOTION_PROFILES[i] = new ResidualVibrationReductionMotionProfilerGenerator(0d, StackTracker.getExtensionHeight(i + 1), 5d * 6d, 50 * 6d);
            ...
            STANDARD_MOTION_PROFILES[i + STANDARD_MOTION_PROFILES.length / 2] = new ResidualVibrationReductionMotionProfilerGenerator(StackTracker.getExtensionHeight(i + 1), -StackTracker.getExtensionHeight(i + 1), 5d * 6d, 50d * 6d);
        }
    }
    ...
    public static ResidualVibrationReductionMotionProfilerGenerator getFeederStoneToOuttakeProfileExtend() {
        return FEEDER_STONE_TO_OUTTAKE_PROFILE_EXTEND;
    }

    public static ResidualVibrationReductionMotionProfilerGenerator getFeederUnderSkybridgeProfileExtend() {
        return FEEDER_UNDER_SKYBRIDGE_PROFILE_EXTEND;
    }

    public static ResidualVibrationReductionMotionProfilerGenerator getFeederStoneToOuttakeProfileRetract() {
        return FEEDER_STONE_TO_OUTTAKE_PROFILE_RETRACT;
    }

    public static ResidualVibrationReductionMotionProfilerGenerator getFeederUnderSkybridgeProfileRetract() {
        return FEEDER_UNDER_SKYBRIDGE_PROFILE_RETRACT;
    }
}
