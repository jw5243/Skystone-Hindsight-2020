package org.firstinspires.ftc.teamcode.ftc15026.control;
...
public class StackTracker {
    ...
    public ResidualVibrationReductionMotionProfilerGenerator motionProfilerSetpoints(boolean extend) {
        ...
        return ResidualVibrationReductionMotionProfilerGenerator.getStandardMotionProfiles()[getStonesStacked() - 1 + (extend ? 0 : 20)];
    }
    ...
    public static ResidualVibrationReductionMotionProfilerGenerator motionProfilerSetpoints(boolean extend, int stonesStacked) {
        ...
        return ResidualVibrationReductionMotionProfilerGenerator.getStandardMotionProfiles()[stonesStacked - 1 + (extend ? 0 : 20)];
    }
